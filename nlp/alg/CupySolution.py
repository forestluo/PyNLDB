...
class CupySolution(Solution) :
    ...
    def __get_gammas(self) :
        ...
        # 结束
        print(f"CupySolution.__get_gammas : finished reindexing vectors !")
        ...
        # 开始
        pb.begin(f"CupySolution.__get_gammas : building matrix !")
        # 初始化相关系数
        ...
        # 结束
        pb.end(f"CupySolution.__get_gammas : finished building matrix !")
        # 返回结果
        return gammas
    ...
    def _solving(self, gammas, ais, bjs) :
        # 打印信息
        print("CupySolution._solving : dump properties !")
    ...
    def _run(self) :
        ...
        # 打印信息
        print(f"CupySolution._run : matrix[{self._size}] initialized !")
